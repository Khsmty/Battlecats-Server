...
module.exports = {
  ...
  execute(interaction) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (
        (commandChannel === null || commandChannel === void 0
          ? void 0
          : commandChannel.parentId) !==
        config_json_1.default.thread.openCategory
      ) {
        ...
        (e, rows) =>
          __awaiter(this, void 0, void 0, function* () {
            ...
            if (
              ...
              (_a = interaction.client.channels.cache.get(
                config_json_1.default.thread.createChannel
              )) === null || _a === void 0
                ? void 0
                ...
                : _b.messages
                    ...
                    .then((msg) => {
                      msg.edit({
                        embeds: [
                          msg.embeds[0],
                          msg.embeds[1].setTitle(newTitle),
                        ],
                      });
                    });
              interaction.reply({
