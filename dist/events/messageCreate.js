...
module.exports = {
  ...
  execute(message) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      // スレッド作成
      if (message.channelId === config_json_1.default.threadCreateChannel) {
        if (!message.content) {
          message.reply({
            embeds: [
        ...
        Bot_1.default.db.query(
          ...
          (e, rows) => {
            if (!rows[0]) {
              ...
              const useChannel = message.client.channels.cache.get(
                useChannelDb.channelId
              );
              useChannel.setParent(config_json_1.default.threadOpenCategoryId);
      ...
      if (
        message.channel.parentId === config_json_1.default.threadOpenCategoryId
      ) {
        Bot_1.default.db.query(
      ...
      if (message.content.startsWith(config_json_1.default.prefix)) {
        ...
        if (!Bot_1.default.messageCommands.has(command)) return;
        try {
