...
module.exports = {
    ...
    execute(interaction) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const userId = (_a = interaction.options.getUser('user')) === null || _a === void 0 ? void 0 : _a.id;
            const messages = [];
            let beforeId;
            for (let i = 0; i < 5; i++) {
                try {
                    const fetchMsgs = yield ((_b = interaction.client.channels.cache.get('822771682157658122')) === null || _b === void 0 ? void 0 : _b.messages.fetch({ limit: 100, before: beforeId }));
