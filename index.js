...
cron.schedule('0,15 * * * *', () => {
  const testCh = client.channels.cache.get('871749703132381185')

  testCh.send('定期実行を開始しました。')
    ...
    switch (interaction.commandName) {
      case 'db': {
        ...
        await interaction.reply({
          embeds: [
            new MessageEmbed()
              .setTitle(`“${interaction.options.getString('word')}” の検索結果`)
              .setDescription(
                search[0]
                  ? search
                      .map(
                ...
                .addOptions([
                  {
                    ...
                    emoji: '❌',
                    default:
                      interaction.member.roles.cache.has('757465906786861166'),
                  },
                  {
                    label: '宣伝を非表示',
                    ...
                    emoji: '❌',
                    default:
                      interaction.member.roles.cache.has('757465944636260463'),
                  },
                  {
                    label: 'にゃんこ以外の雑談を非表示',
                  ...
                  },
                  {
                    ...
                    emoji: '⭕',
                    default:
                      interaction.member.roles.cache.has('884754990462279730'),
                  },
                  {
                    label: '全ロールを一括削除',
                    value: 'clear',
                ...
                .addOptions([
                  {
                    ...
                    emoji: '🧑‍🏫',
                    default:
                      interaction.member.roles.cache.has('757466064702537748'),
                  },
                  {
                    label: '画像・動画リクエストOK',
                    ...
                    emoji: '🖼️',
                    default:
                      interaction.member.roles.cache.has('856005613368246325'),
                  },
                  {
                    label: 'メンションNG',
                    ...
                    emoji: '❌',
                    default:
                      interaction.member.roles.cache.has('818062825024520243'),
                  },
                  {
                    label: '全ロールを一括削除',
                    value: 'clear',
                ...
                .addOptions([
                  {
                    ...
                    emoji: '🔔',
                    default:
                      interaction.member.roles.cache.has('871410296705658930'),
                  },
                  {
                    label: '極ゲリラ経験値にゃ！',
                    ...
                    emoji: '🔔',
                    default:
                      interaction.member.roles.cache.has('871410800575787041'),
                  },
                  {
                    label: '超極ゲリラ経験値にゃ！',
                    ...
                    emoji: '🔔',
                    default:
                      interaction.member.roles.cache.has('871410888429674536'),
                  },
                  {
                    ...
                    emoji: '🔔',
                    default:
                      interaction.member.roles.cache.has('871411418459684875'),
                  },
                  {
                    ...
                    emoji: '🔔',
                    default:
                      interaction.member.roles.cache.has('871411529482907679'),
                  },
                  {
                    ...
                    emoji: '🔔',
                    default:
                      interaction.member.roles.cache.has('871411632365006918'),
                  },
                  {
                    label: '悪魔ネコステージ',
                    ...
                    emoji: '🔔',
                    default:
                      interaction.member.roles.cache.has('876131805827301457'),
                  },
                  {
                    label: '悪魔タンクネコステージ',
                    ...
                    emoji: '🔔',
                    default:
                      interaction.member.roles.cache.has('876132058936774676'),
                  },
                  {
                    label: '開眼のネコフラワー',
                    ...
                    emoji: '🔔',
                    default:
                      interaction.member.roles.cache.has('876132175613935656'),
                  },
                  {
                    label: '悪魔バトルネコ',
                    ...
                    emoji: '🔔',
                    default:
                      interaction.member.roles.cache.has('871411756017279096'),
                  },
                  {
                    label: '女王の研究報告1',
                    ...
                    emoji: '🔔',
                    default:
                      interaction.member.roles.cache.has('871411821985267732'),
                  },
                  {
                    label: '女王の研究報告2',
                    ...
                    emoji: '🔔',
                    default:
                      interaction.member.roles.cache.has('871411874497961994'),
                  },
                  {
                    label: '未設定 (イベント1)',
                    ...
                    emoji: '🔔',
                    default:
                      interaction.member.roles.cache.has('885915916213305375'),
                  },
                  {
                    label: '未設定 (イベント2)',
                    ...
                    emoji: '🔔',
                    default:
                      interaction.member.roles.cache.has('885915963860598844'),
                  },
                  {
                    label: '未設定 (イベント3)',
                    ...
                    emoji: '🔔',
                    default:
                      interaction.member.roles.cache.has('885915967937474652'),
                  },
                  {
                    label: '未設定 (イベント4)',
                    ...
                    emoji: '🔔',
                    default:
                      interaction.member.roles.cache.has('871411924460531742'),
                  },
                  {
                    label: '全ロールを一括削除',
                    value: 'clear',
                ...
                .addOptions([
                  {
                    ...
                    emoji: '⚔',
                    default:
                      interaction.member.roles.cache.has('868827768203382814'),
                  },
                  {
                    label: 'ポケットモンスター',
                    ...
                    emoji: '⚾',
                    default:
                      interaction.member.roles.cache.has('884724976173842502'),
                  },
                  {
                    label: '全ロールを一括削除',
                    value: 'clear',
